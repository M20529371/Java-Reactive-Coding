package com.selflearning.sec03.assignment;
...
public class StockPriceObserver implements Subscriber<Integer> {
    ...
    public void onNext(Integer price) {
        if(price<90 && balance>=price){
            ...
            log.info("bought a stock at {}, total quantit: {}, remaining balance: {}", price, quantity, balance);
        }else if(price>110&& quantity>0){
            log.info("Selling {} quantity at {}", quantity, price);
